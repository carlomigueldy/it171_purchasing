...
if(isset($_POST["supplier_id"]) && !empty($_POST["supplier_id"])){
    ...
    if(empty(trim($_GET["supplier_id"]))){
                ...
                <div class="col-md-12"><br><br><br><br>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade show">
                            ...
                            <input type="hidden" name="supplier_id" value="<?php echo trim($_GET["supplier_id"]); ?>"/>
                            <p>Are you sure you want to delete this supplier?<br>(Supplier ID: <?php echo $_GET["supplier_id"];?>)</p><br>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger">
                                <a href="suppliers.php" class="btn btn-primary">No</a>
                            </p>
                        </div>
                    </form>
                </div>
