                    ...
                    <div class="page-header clearfix">
                        ...
                        <form action="" class="form-inline float-right" method="POST">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active" href="purchase-order-filter-by-asc-approved.php"><small>Approved</small></a>
                                ...
                                <a class="dropdown-item" href="purchase-order-filter-by-asc-totalamount.php"><small>Total Amount</small></a>
                                ...
                                echo "<table id='purchaseOrder' class='table table-bordered table-striped table-hover table-sm header-fixed'>";
                                    echo "<thead class='thead-dark'>";
                                        echo "<tr align='center'>";
                                            echo "<th onclick='sortTable(1)'>#</th>";
                                            echo "<th onclick='sortTable(2)'>Supplier<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th onclick='sortTable(3)'>Date & Time<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th onclick='sortTable(4)'>Term<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th onclick='sortTable(5)'>Total Amount<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th onclick='sortTable(6)'>Prepared By<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th onclick='sortTable(7)'>Status<small><i class='fa fa-fw fa-sort'></i></small></th>";
                                            echo "<th>Action</th>";
                                        echo "</tr>";
                                    echo "</thead>";
                                    echo "<tbody>";
